...
export const defaultLayouts: Layouts = {
    xxl: [ // Desktop Large (≥1400px) -> 12 Cols
        { i: 'energy-cost', x: 0, y: 0, w: 4, h: 2, minW: 3, minH: 2 },
        { i: 'active-power', x: 4, y: 0, w: 4, h: 2, minW: 2, minH: 2 },
        { i: 'energy-accumulated', x: 8, y: 0, w: 4, h: 2, minW: 2, minH: 2 },
        { i: 'voltage', x: 0, y: 2, w: 3, h: 2, minW: 2, minH: 2 },
        { i: 'current', x: 3, y: 2, w: 3, h: 2, minW: 2, minH: 2 },
        { i: 'power-factor', x: 6, y: 2, w: 3, h: 2, minW: 2, minH: 2 },
        { i: 'statistics', x: 9, y: 2, w: 3, h: 2, minW: 2, minH: 2 },
    ],
    xl: [ // Desktop (1200px - 1399px) -> 10 Cols
        { i: 'energy-cost', x: 0, y: 0, w: 4, h: 2, minW: 3, minH: 2 },
        { i: 'active-power', x: 4, y: 0, w: 3, h: 2, minW: 2, minH: 2 },
        { i: 'energy-accumulated', x: 7, y: 0, w: 3, h: 2, minW: 2, minH: 2 },
        { i: 'voltage', x: 0, y: 2, w: 2, h: 2, minW: 2, minH: 2 },
        { i: 'current', x: 2, y: 2, w: 2, h: 2, minW: 2, minH: 2 },
        { i: 'power-factor', x: 4, y: 2, w: 2, h: 2, minW: 2, minH: 2 },
        { i: 'statistics', x: 6, y: 2, w: 4, h: 2, minW: 2, minH: 2 },
    ],
    lg: [ // Laptop (992px - 1199px) -> 8 Cols
        { i: 'energy-cost', x: 0, y: 0, w: 4, h: 2, minW: 3, minH: 2 },
        { i: 'active-power', x: 4, y: 0, w: 4, h: 2, minW: 2, minH: 2 },
        { i: 'energy-accumulated', x: 0, y: 2, w: 4, h: 2, minW: 2, minH: 2 },
        { i: 'statistics', x: 4, y: 2, w: 4, h: 2, minW: 2, minH: 2 },
        { i: 'voltage', x: 0, y: 4, w: 2, h: 2, minW: 2, minH: 2 },
        { i: 'current', x: 2, y: 4, w: 2, h: 2, minW: 2, minH: 2 },
        { i: 'power-factor', x: 4, y: 4, w: 4, h: 2, minW: 2, minH: 2 },
    ],
